...
export default function ProjectPage() {
  ...
  <section className="text-neutral-100">
    <div className="px-0 md:px-12 lg:px-36 mb-4">
    ...
    <div className="container px-0 md:px-12 lg:px-36 grid grid-cols-1 lg:grid-cols-2">
      <div className="flex flex-col my-3 lg:mr-3 bg-neutral-900">
      ...
      <div className="flex flex-col my-3 lg:ml-3 bg-neutral-900">
        <div className="p-4 pb-0">

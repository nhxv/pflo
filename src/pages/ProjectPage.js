...
export default function ProjectPage() {
  ...
  <section className="text-neutral-100">
    <div className="px-0 md:px-12 lg:px-36 mb-8">
    ...
    <div className="container px-0 md:px-12 lg:px-36 grid grid-cols-1 lg:grid-cols-2">
      ...
      bg-neutral-900">
        ...
        <div className="p-6">
          <h6 className="font-semibold text-lg mb-1">Mangastore</h6>
          ...
          <p className="my-4 text-neutral-400">A fullstack manga e-commerce web application that allow users to search and purchase manga.</p>
      ...
      <div className="flex flex-col bg-neutral-900">
        ...
        <div className="p-6">
          <h6 className="font-semibold text-lg mb-1">Unique Fashion Store</h6>
          <div className="flex flex-row flex-wrap">
            <span className="my-1 mr-2 p-1 font-medium border-2  
